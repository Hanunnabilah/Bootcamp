...
class Cat : Animal //tanda : --> dog adalah child dari parent animal
{
	...
	public void Play() {}
	// constructor for cat
	public Cat(int age, string gender, string name, string ras,string kumis) : base(age, gender, name, ras)
	{
...
class Dog : Animal //tanda : --> dog adalah child dari parent animal
{
	...
	public void Play() {}
	// constructor for dog
	public Dog(int age, string gender, string name, string ras, string kumis) : base(age, gender, name, ras)
	{
		this.moustache = kumis;
